...
public class SeriesCriteriaRepository {
    ...
    public List<SeriesModel> buscarSeriesPorCriteria (
            String title,
        ...
        CriteriaQuery<SeriesModel> cq = cb.createQuery(SeriesModel.class);
        Root<SeriesModel> root = cq.from(SeriesModel.class);
        ...
        Join<SeriesModel, ActorModel> actoresJoin = root.join("actores",
                JoinType.LEFT);
        ...
        Join<SeriesModel, DirectorModel> directorJoin = root.join("director",
                JoinType.LEFT);
        ...
        Join<SeriesModel, ProductoraModel> productoraJoin = root.join("productora",
                JoinType.LEFT);
