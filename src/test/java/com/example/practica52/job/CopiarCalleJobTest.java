...
@SpringBatchTest
@SpringBootTest
public class CopiarCalleJobTest {

    @Autowired
    private Job copiarTodasLasCallesJob;
    @Autowired
    private JobLauncherTestUtils jobLauncherTestUtils;

    @BeforeEach
    void setUp(){
        jobLauncherTestUtils.setJob(copiarTodasLasCallesJob);
    }

    @Test
    void copiarCalleJobTest_shouldBeCompleted() throws Exception {
