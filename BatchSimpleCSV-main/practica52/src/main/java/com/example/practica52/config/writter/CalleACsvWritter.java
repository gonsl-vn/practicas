...
public class CalleACsvWritter {
    ...
    public ItemWriter<Calle> writeCalleACsv(){
        ...
        writer.setResource(new FileSystemResource("C:\\Users\\6003351\\Desktop\\Practicas\\BatchSimpleCSV-main\\practica52\\src\\main\\resources\\calles_exportadas.csv"));
        ...
        fieldExtractor.setNames( new String[]{"id", "barrio", "codigoCalle",
    ...
    private void iniciaFicheroCsv(){
        File file = new File("C:\\Users\\6003351\\Desktop\\Practicas\\BatchSimpleCSV-main\\practica52\\src\\main\\resources\\calles_exportadas.csv");
        if(!file.exists()){
            try{
                file.createNewFile();
            }catch(Exception e){
